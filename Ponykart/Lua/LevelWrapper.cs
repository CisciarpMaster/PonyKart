...
namespace Ponykart.Lua {
	...
	public class LevelWrapper {
		...
		[LuaFunction("getLevelFlag", "Gets a boolean flag from the level. If the flag is not found then this will return false and you'll get "+
		...
		[LuaFunction("getLevelNumber", "Gets a number from the level. If the number is not found then this will return -1 and you'll get " +
