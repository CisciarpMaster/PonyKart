function flat(level)
	...
	berry = spawn("BgPonyBerry", vector(30, 3, 0))
	cherry = spawn("BgPonyCherry", vector(49, -0.9, 5))
	sun = spawn("BgPonySun", vector(32, 8, -3))
	dizzy = spawn("BgPonyDizzy", vector(24, 7.5, -3.5))
