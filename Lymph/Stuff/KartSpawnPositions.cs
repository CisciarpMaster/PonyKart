...
namespace Ponykart.Stuff {
    ...
    public class KartSpawnPositions : IDisposable {
        ...
        public KartSpawnPositions() {
            ...
            dict[0] = new Vector3(0, 0, 0);
            dict[1] = new Vector3(0, 0, -3);
            dict[2] = new Vector3(0, 0, -6);
            dict[3] = new Vector3(-3, 0, 0);
            dict[4] = new Vector3(-3, 0, -3);
            dict[5] = new Vector3(-3, 0, -6);
            dict[6] = new Vector3(-6, 0, 0);
            dict[7] = new Vector3(-6, 0, -3);
        }
